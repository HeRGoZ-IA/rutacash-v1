...
function v1ToV6(uuid) {
	var v6Bytes = _v1ToV6(typeof uuid === "string" ? parse(uuid) : uuid);
...
function v6(options = {}, buf, offset = 0) {
	var bytes = v1(_objectSpread(_objectSpread({}, options), {}, { _v6: true }), new Uint8Array(16));
	bytes = v1ToV6(bytes);
	if (buf) {
		for (var i = 0; i < 16; i++) buf[offset + i] = bytes[i];
		return buf;
...
function v6ToV1(uuid) {
	var v1Bytes = _v6ToV1(typeof uuid === "string" ? parse(uuid) : uuid);
