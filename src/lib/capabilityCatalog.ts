...
export const CAPABILITY_METADATA: Record<Capability, CapabilityMeta> = {
  ...
  'cashbox.viewRoute': { key: 'cashbox.viewRoute', label: 'Consultar caja de ruta', description: 'Ver la caja financiera de las rutas autorizadas, incluido el capital.', category: 'Pagos y caja', risk: 'medio' },
  'cashbox.viewOwnCollection': { key: 'cashbox.viewOwnCollection', label: 'Ver mi caja de recaudo', description: 'Ver el efectivo propio: lo recaudado, lo desembolsado y los gastos del día. No incluye el capital de la ruta.', category: 'Pagos y caja' },
